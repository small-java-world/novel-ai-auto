...
- **関連ファイル**:
  ...
  - プロンプトファイル仕様: `docs/spec/prompt-file-format.md`
  - 実装メモ: `docs/implements/TASK-102/` (実装時に作成)
- **実装詳細**:
  - 新フォーマット（v1.0）のプロンプトファイル対応
  - メタデータ（作成者、説明、タグ等）の表示・管理機能
  - 既存のJSON形式との互換性確保、バージョン管理
- **テスト要件**:
